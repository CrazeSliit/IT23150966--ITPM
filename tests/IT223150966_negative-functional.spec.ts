 ...
 * Total Test Cases: 10
 * Test Data Source: test-data/negative-functional.json
 * 
 * What is tested:
...
const testDataPath = path.join(__dirname, '../test-data/negative-functional.json');
const testCases: NegativeTestCase[] = JSON.parse(fs.readFileSync(testDataPath, 'utf-8'));
