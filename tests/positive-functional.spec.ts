 ...
 * Total Test Cases: 24
 * Test Data Source: test-data/positive-functional.json
 * 
 * What is tested:
...
const testDataPath = path.join(__dirname, '../test-data/positive-functional.json');
const testCases: PositiveTestCase[] = JSON.parse(fs.readFileSync(testDataPath, 'utf-8'));
